...
const Results = ({
  ...
  return (
    <div className="px-4 mb-10 relative md:grid md:grid-cols-3 md:gap-x-5 md:px-8 md:mb-16 xl:max-w-130 xl:mx-auto">
      <div className="p-4 rounded-lg border border-neutral-700 mb-4 md:px-6 xl:px-6">
